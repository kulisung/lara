...
Route::post('searchs/pos_update', 'SearchsController@pos_update')->name('searchs.pos_update');
...
Route::post('searchs/COPINV_Query', 'SearchsController@COPINV_Query')->name('searchs.COPINV_Query');
