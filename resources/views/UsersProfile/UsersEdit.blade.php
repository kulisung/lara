    ...
    <div class="row justify-content-center">
        <div class="col-md-8"><br>
            <form method="post" action="{{ route('UsersProfile.UsersUpdate', $user->username) }}">
                ...
                <div class="card-body">
                    <div><label class="col-md-4 col-form-label text-md-right" style="font-size:14px">Login-ID：</label><input type="text" name="username" value="{{ $user->username }}" readonly><label style="font-size:10px">(ReadOnly無法修改)</label></div>
                    <div><label class="col-md-4 col-form-label text-md-right" style="font-size:14px">Name：</label>
                    <input type="text" name="name" value="{{ $user->name }}"></div>
                    <div><label class="col-md-4 col-form-label text-md-right" style="font-size:14px">User Level：</label>
                    <input type="text" name="user_level" value="{{ $user->user_level }}"></div>
                    <div><label class="col-md-4 col-form-label text-md-right" style="font-size:14px">E-mail：</label>
